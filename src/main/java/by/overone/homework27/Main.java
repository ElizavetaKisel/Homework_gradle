...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("Самое часто встречающееся слово: " + Analysis.findMostRecent(text));
        System.out.println("Самое длинное слово: " + Analysis.findLonger(text));
        ...
        System.out.println("Самое часто встречающееся слово: " + Analysis.findMostRecent(text2));
        System.out.println("Самое длинное слово: " + Analysis.findLonger(text2));
